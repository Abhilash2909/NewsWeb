...
//     return (
//         <div className="card news-card bg-dark text-light mb-3 d-inline-block mx-3 my-3 px-2 px-2" style={{ maxWidth: "345px", height: "100%" }}>
...
const NewsItem = ({ title, description, src, url }) => {
    ...
    return (
        <div className="card news-card bg-dark text-light mb-3 mx-3 px-2">
            <img 
                src={src ? src : image} 
